...
import { useStore, BEASTS, PLAYER_RANKS } from '../store/useStore';
      ...
      <div className="relative z-10 w-full max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-zinc-500">
            {currentRank.icon} {currentRank.title} — {player.totalAccumulatedMins} min acumulados
          </p>
        </div>
        ...
        {!ritualStep && (
          <div className="flex flex-col gap-4 max-w-xs mx-auto">
            <button
              ...
              className="btn-pixel border-4 border-zinc-600 bg-zinc-900 hover:bg-zinc-800 text-zinc-400 text-xs px-8 py-3"
            >
              ← VOLVER AL HUB
            </button>
            <button
            ...
            <button
              ...
              className="btn-pixel border-4 border-zinc-400 bg-zinc-800 hover:bg-zinc-700 text-white text-sm md:text-base px-8 py-4"
            >
              📜 DOMINIOS
            </button>
            <button
        ...
        {ritualStep !== null && (
          <div className="border-4 border-white bg-zinc-900 shadow-[4px_4px_0_0_rgba(0,0,0,1)] p-6">
            {/* Step Indicator */}
            <div className="flex justify-center gap-2 mb-6">
              <div className={`w-3 h-3 border-2 ${ritualStep >= 1 ? 'bg-amber-400 border-amber-400' : 'bg-zinc-700 border-zinc-600'}`} />
              <div className={`w-3 h-3 border-2 ${ritualStep >= 2 ? 'bg-amber-400 border-amber-400' : 'bg-zinc-700 border-zinc-600'}`} />
              <div className={`w-3 h-3 border-2 ${ritualStep >= 3 ? 'bg-amber-400 border-amber-400' : 'bg-zinc-700 border-zinc-600'}`} />
            </div>
              ...
              <div className="text-center">
                    ...
                    <button
                      ...
                      className={`btn-pixel px-4 py-3 text-sm ${
                        selectedDuration === opt.value
                          ...
                          : 'border-2 border-zinc-600 bg-zinc-800 hover:bg-zinc-700'
                      }`}
                    >
                      {opt.label}
                    </button>
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    className="flex-1 btn-pixel border-2 border-zinc-600 bg-zinc-800 hover:bg-zinc-700 text-zinc-400 text-sm px-4 py-3"
                  >
                    VOLVER
                  </button>
                  <button
                    ...
                    className={`flex-1 btn-pixel text-sm px-4 py-3 ${
                      selectedDuration
                        ...
                        : 'border-2 border-zinc-600 bg-zinc-700 text-zinc-500 cursor-not-allowed'
                    }`}
                  >
                    CONTINUAR
                  </button>
            ...
            {ritualStep === 2 && (
              <div className="text-center">
                ...
                {domains.length === 0 ? (
                  <div className="p-4 border-2 border-zinc-600 bg-zinc-800 mb-6">
                  ...
                  <div className="max-h-48 overflow-y-auto border-2 border-zinc-600 bg-zinc-950 mb-6">
                    {domains.map((domain) => (
                      <button
                        key={domain.id}
                        onClick={() => setSelectedDomainId(domain.id)}
                        className={`w-full p-3 text-left border-b border-zinc-700 ${
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-xs text-zinc-500">
                            {domain.currentDebtMins <= 0 ? (
                              <span className="text-zinc-500">✓ DERROTADO</span>
                            ) : (
            ...
            {ritualStep === 3 && (
              <div className="relative">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <div className="mb-6 p-4 border-4 border-amber-400 bg-zinc-950/90 shadow-[4px_4px_0_0_rgba(0,0,0,1)]">
                    <div className="flex flex-col md:flex-row items-center gap-4">
                      {/* Boss Sprite Preview */}
                      <div className="w-32 h-32 bg-zinc-800 border-4 border-zinc-600 flex items-center justify-center overflow-hidden">
                        <img
                  ...
                  {/* Boss Selection Grid */}
                  <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 mb-6 max-h-64 overflow-y-auto p-3 border-2 border-zinc-700 bg-zinc-950/90">
                    {Object.values(BEASTS).map((beast) => (
                      ...
                      >
                        {/* Boss Mini Sprite */}
                        <div className="w-12 h-12 bg-zinc-800 border-2 border-zinc-700 flex items-center justify-center overflow-hidden mb-1">
                          <img
                            src={beast.spriteImg}
                            alt={beast.name}
                            className="w-full h-full object-contain"
                  ...
                  {/* Ritual Summary */}
                  <div className="p-3 border-2 border-zinc-600 bg-zinc-950/90 mb-6 text-left">
                    <p className="text-xs text-zinc-400 mb-1">RESUMEN DEL RITUAL:</p>
